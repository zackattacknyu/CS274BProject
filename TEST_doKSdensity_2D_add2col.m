...
precipDensNorm = cell(1,numFeats);
noPrecipDensNorm = cell(1,numFeats);

precipDensUnNorm = cell(1,numFeats);
noPrecipDensUnNorm = cell(1,numFeats);
...
%%
save('KSdensity2dVars_sep2012_new3inds_with2Col.mat','precipDensNorm',...
    'noPrecipDensNorm','precipDensUnNorm','noPrecipDensUnNorm');
%%
load('KSdensity2dVars_sep2012_new3inds_with2Col')
%%
for feat = 1:numFeats
   figure
   subplot(1,2,1)

...
if(useOnlyWindows)
    crfAndLogData = load('logRegressionAndCrfROCvars_sep2012data_new3_inWindow.mat');
    patchCRFdata = load('ROCvars_sep2012_new3PatchTrainP_testInds.mat');
    ...
    crfAndLogDataTrain = load('logRegressionAndCrfROCvars_sep2011data_new3_inWindow.mat');
    patchCRFdataTrain = load('ROCvars_sep2011_patchPred_new3_trainingInds.mat');
    ...
    patchCRFdata = load('ROCvars_sep2012_new3PatchTrainP_testInds_wholeMap.mat');

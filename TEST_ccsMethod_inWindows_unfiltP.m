...
load('ROCvars_sep2011_patchPred_new3_trainingInds_patchData_unfilteredP.mat',...
    'patchCoordsTrain')
...
load('ROCvars_sep2012_new3PatchTrainP_testInds_wholeMap_baselineDataMini_unfilteredP',...
    'patchCoords');
...
save('logRegressionAndCcsROCvars_sep2012data_new3_inWindow_unfilteredP.mat',...

...
[feats,efeats,labels,models,precipImages,ccsLabels,ccsYvalues] = ...
    obtainDataFromFiles3_add4col(trainingInds,...
...
%%
XX = XdataTrain(testPixels,[1:13 16:19]); %take out the two constant columns
XXwo = XdataTrain(testPixels,1:13);
...
XX2 = XdataTest(testPixels2,[1:13 16:19]);
XX2wo = XdataTest(testPixels2,1:13);
...
save('logisticRegressionTest_sep2012data_new3_with4Extra.mat',...
...
load('logisticRegressionTest_sep2012data_new3_with4Extra.mat');
%%
figure
